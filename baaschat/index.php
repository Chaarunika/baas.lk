...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Baas.lk Private messages</title>
    </head>
    <body>
    	<div class="header">
...
Welcome to the private messaging section of our website.<br />
...
?>
<a href="edit_infos.php">Edit my personal information</a><br />
<a href="list_pm.php">My personal messages(<?php echo $nb_new_pm; ?> unread)</a><br />
...
?>
		...
		<div class="foot"><a href="http://baas.lk">Home</a></div>
	</body>
</html>