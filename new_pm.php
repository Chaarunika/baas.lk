	...
	if($_POST['title']!='' and $_POST['recip']!='' and $_POST['message']!='')
	{
		...
		if($dn1['recip']==='1')
		{
			...
			if($dn1['recipid']!=$_SESSION['userID'])
			{
				...
				{
?>
<div class="message">The message was sent successfully.
</div>
<?php
					$form = false;
				}
...
<div class="content">
    ...
    <form action="new_pm.php" method="post">
		...
		<label for="title">Title</label><input type="text" value="<?php echo htmlentities($otitle, ENT_QUOTES, 'UTF-8'); ?>" id="title" name="title" /><br /><br/>
        <label for="recip">Recipient<span class="small">(Username)</span></label><input type="text" value="<?php echo htmlentities($orecip, ENT_QUOTES, 'UTF-8'); ?>" id="recip" name="recip" /><br /><br/>
        <label for="message">Message</label><textarea cols="40" rows="5" id="message" name="message"><?php echo htmlentities($omessage, ENT_QUOTES, 'UTF-8'); ?></textarea><br /><br/></font>
